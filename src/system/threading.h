...
************************************************************************/  
#pragma once
#ifndef ENG_THREADING_H_
#define ENG_THREADING_H_
#include <atomic>
#include <functional>
#include <thread>
#include <vector>
namespace eng {
	...
	public:
		template <typename T>
		static void run(const T &target, int begin, int end, int num_threads) {
		...
		template <typename T>
		static void run(const T &target, int end, int num_threads) {
